...
<div align=center><a href="https://github.com/Taludas/NoblesseOblige/releases/latest/download/NoblesseOblige.zip"> <font size="40">Jetzt herunterladen</font></a></div>

In diesem Repo findet ihr die Modifikation Noblesse Oblige für Anno 1800
...
- **Pontifikalamt in der Kathedrale**: Nach Abschluss des Events zeigt die Benutzeroberfläche nur den Buff an, der nach Abschluss als Belohnung gewährt wird. Tatsächlich erhält man aber immer noch die versprochenen 3 Items aus den jeweiligen Loottables. Sie werden nur nicht in diesem UI angezeigt, sondern sind wie gewohnt in eurem Kontor verfügbar.
